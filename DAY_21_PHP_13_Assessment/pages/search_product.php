                ...
                <div class="col-md-4 mb-4 mx-auto">
                    <div class="card">
                        ...
                        <div class="card-body bg-dark text-white">
                            ...
                            <h3 class="card-title">Product Name: <?php echo $result['name'];?></h3>
                            <h3 class="">Product Price: BDT <?php echo $result['price'];?></h3>
                            <hr/>
                            <a href="action.php?pages=detail&&id=<?php echo $result['id'];?>" class="btn btn-outline-light">Details</a>
                        </div>
                    </div>
                </div>
            <?php } else {?>
