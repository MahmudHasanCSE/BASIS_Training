        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 mx-auto">
                    <div class="card">
                        <div class="card-header bg-secondary text-white">My Series</div>
                        <div class="card-body bg-secondary text-white">
                            <form action="action.php" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <label><input type="radio" class="" name="odd_even" value="odd"/>Odd</label>
                                        <label><input type="radio" class="" name="odd_even" value="even"/>Even</label>
                                    </div>
                                </div>
                                <div class="form-group row">
